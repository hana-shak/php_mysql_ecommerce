...
if($connection){
    ...
    echo "ur not connected".mysqli_connect_error();
}
...
if (isset($_POST['customer_submit'])){
    ...
    $query  = "SELECT * FROM customers (customer_name, customer_email, customer_phone, customer_password, customer_address) 
    ...
    //                (customer_name, customer_email, customer_phone, customer_password, customer_address) 
    //                VALUES ('$customer_name' , '$customer_email' ,'$customer_phone' , '$customer_password' , '$customer_address' ) ";
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)){
                                            ...
                                            echo "<tr>";
                                              ...
                                              echo "<td><a href='customer_edit.php?id={$row['customer_id']}' class='btn btn-primary'>Edit</a></td>";
                                              echo "<td><a href='customer_delete.php?id={$row['customer_id']}' class='btn btn-danger'>Delete</a></td>";
                                              echo "</tr>";
                                        }
